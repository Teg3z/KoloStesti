...
list_her = [apex, pubg, csgo, fortnite, programovani, lost_ark, lolko, fall_guys, overwatch, gta, keep_talking, orcs,
            deceive, dead_by_daylight, dying_light]
...
for hra in list_her:
    list_her_grafika.append(
        grafika.Text(hra.nazev, text_color=front, font=nas_font, background_color=back, key=hra.nazev))
